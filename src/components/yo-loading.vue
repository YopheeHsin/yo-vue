<template>
<div class="yo-loading" :class="[
	'yo-loading--' + type,
	'yo-loading--' + color
]" :style="style">
	<span class="yo-loading__spinner" :class="'yo-loading__spinner--' + type">
		<i v-for="n in (type === 'spinner' ? 12 : 0)" :key="n" />
		<svg v-if="type === 'circular'" class="yo-loading__circular" viewBox="25 25 50 50">
